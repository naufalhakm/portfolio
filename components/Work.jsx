    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                Welcome to my backend development portfolio! Explore a collection of projects
                ...
                <motion.div
                    ...
                    {workData.map((project, index) => (
                        <motion.div
                            ...
                            key={index}
                            className="max-w-[400px] h-[240px] aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group"
                        ...
                        py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
                            ...
                            aspect-square flex items-center justify-center shadow-[2px_2px_#000] group-hover:bg-lime-300 transition">
